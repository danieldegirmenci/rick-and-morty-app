<template>
  <button @click="previousPage" class="previousTop button">
    Previous Page
  </button>
  ...
  <div class="containerCard" v-if="result">
    ...
    >
      <div class="card">
        ...
        <div
          class="card-body"
          style="background-color: #64c09b; color: #011307"
        >
          <h5 class="card-title">
            {{ character.name }}
          </h5>
  ...
  <div class="bottomButtons">
    <button @click="previousPage" class="previousBottom button">
      Previous Page
    </button>
...
export default {
  ...
  methods: {
    nextPage() {
      if (variables.page < this.result.characters.info.pages) {
        variables.page++;
      }
    },
    previousPage() {
