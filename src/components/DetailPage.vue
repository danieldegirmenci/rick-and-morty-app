    ...
    <div v-if="result">
        ...
        <div class="allInfo">
            ...
            <div class="subInfo">
                ...
                <div class="key-value">
                    <span>Last seen : </span> <span>{{ result.character.location.name }}</span>
                </div>
                <div class="key-value">
                    <span>First Episode : </span> <span>{{ result.character.episode[0].name }}</span>
                </div>
...
export default {
    ...
    setup() {
        const { result, loading, } = useQuery(DETAIL_QUERY, reactive({
